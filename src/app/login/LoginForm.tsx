  ...
  return (
    <form action={formAction} className="space-y-4">
      <div>
        ...
        <div className="flex items-center gap-2 rounded-md border border-slate-200 px-3 py-2.5 focus-within:ring-2 focus-within:ring-emerald-500/30">
      ...
      <button
        type="submit"
        disabled={pending}
        className="flex w-full items-center justify-center gap-2 rounded-md bg-emerald-700 py-2.5 text-sm font-semibold text-white hover:bg-emerald-800 disabled:opacity-60"
      >
